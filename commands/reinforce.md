...
2. Run a short Socratic drill on that concept: a question that surfaces the misunderstanding,
   then guide with the `/hint` ladder as needed. Do NOT write the solution — make them work it.
